...
const TimeDurationPicker: React.FC<TimeDurationPickerProps> = ({
  ...
  return (
    <>
      ...
      >
        <span>{`${formatTime(selectedTime)} (${formatDuration(duration)})`}</span>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            ...
            >
              <div className="flex items-center justify-between p-4 border-b">
                <h2 className="text-lg font-semibold">Select Time & Duration</h2>
                <button
...
const BookingPage = () => {
  ...
  const handleTimeAndDurationChange = (newTime: TimeSelection, newDuration: number) => {
    setBooking(prev => ({
      ...prev,
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="w-64">
            <TimeDurationPicker 
              ...
              onSelect={(time, duration) => handleTimeAndDurationChange(time, duration)}
            />
          </div>
        </div>
        ...
        <div className="border-t pt-6">
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <p className="text-gray-600">INR {TICKET_PRICE.toFixed(2)} / Ticket</p>
            </div>
        ...
        {/* Add to Cart Button */}
        <button 
          className="w-full py-3 bg-gray-100 text-gray-500 rounded-md hover:bg-gray-200 transition-colors"
